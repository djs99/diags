...
cinder_diagnostics_group = cfg.OptGroup(name="cinder_diagnostics",
                                     title="Cinder Diagnostics Options")

CinderDiagnosticsGroup = [
   
    cfg.StrOpt('cinder_ssh_ip',
               help="Cinder Node IP for ssh coonnection"),
    cfg.StrOpt('cinder_ssh_user',
               help="SSH username to connect to cinder node"),
    cfg.StrOpt('cinder_ssh_password',
               help="SSH password to connect to cinde node"),
...
_opts = [
    ...
    (cinder_diagnostics_group, CinderDiagnosticsGroup)
]
